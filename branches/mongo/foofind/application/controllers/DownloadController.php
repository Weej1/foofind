...
class DownloadController extends Zend_Controller_Action
{
    ...
    public function init()
    {
        ...
        $amerge[] =  FOOFIND_PATH . '/public/js/jquery.bgiframe.js';
        $amerge[] =  FOOFIND_PATH . '/public/js/jquery.dimensions.js';
        $amerge[] =  FOOFIND_PATH . '/public/js/jquery.tooltip.js';
        $amerge[] =  FOOFIND_PATH . '/public/js/jquery.superbox-min.js';
        //$this->view->mergedjs = $this->_helper->mergejs->merge( $amerge);

        $this->view->headScript()->captureStart();
        $this->view->headScript()->appendFile($this->_helper->mergejs->merge( $amerge) );
