...
$cookiename	= 'foofind';				// Optional change: Give the cookie a name. Default is sascookie
$expirytime	= time()+3600*365;				// Optional change: Set an expiry time for the password (in seconds). Default is 1 hour.
...
global $cookiename,$encrypt_pass,$expirytime,$domain;
	setcookie($cookiename,$encrypt_pass,$expirytime, '/',".foofind.dev");
}	
...
<div id="main">
	<div id="mid">
		...
		<p>(You will need to enable cookies to work as expected.)</p>
