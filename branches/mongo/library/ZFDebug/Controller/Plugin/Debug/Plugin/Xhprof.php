...
class ZFDebug_Controller_Plugin_Debug_Plugin_Xhprof extends Zend_Controller_Plugin_Abstract implements ZFDebug_Controller_Plugin_Debug_Plugin_Interface
{
    ...
    public function preDispatch(Zend_Controller_Request_Abstract $request)
    {
        if (function_exists('xhprof_enable')) {
            ...
            include_once '/home/leo/workspace/xhprof-0.9.2/xhprof_lib/utils/xhprof_lib.php';
            include_once '/home/leo/workspace/xhprof-0.9.2/xhprof_lib/utils/xhprof_runs.php';
    ...
    public function postDispatch(Zend_Controller_Request_Abstract $request)
    {
        if (function_exists('xhprof_enable')) {
            ...
            $profiler_namespace = 'foofind';  // namespace for your application
