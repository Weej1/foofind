...
class Bootstrap extends Zend_Application_Bootstrap_Bootstrap
{
    ...
    protected function _initPlugins()
    {
        ...
        //set the file panel page route
        $routeFilepanel = new Zend_Controller_Router_Route( ':language/filepanel/:uri/*', array( 'language' => null, 'controller' => 'filepanel', 'action' => 'file') );
        ...
        $router->addRoute ( 'panel/uri', $routeFilepanel );
